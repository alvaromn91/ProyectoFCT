...
insert into MANAGER_COLEGIO(ID, NOMBRE, APELLIDO_1, APELLIDO_2, FECHA_NACIMIENTO, NACIONALIDAD, PAIS, CIUDAD, CP, DIRECCION, EMAIL, NICK, CONTRASENA, TELEFONO_1, TELEFONO_2, ID_COLEGIO, DELETED, F_BORRADO)
                            VALUES(1, 'MARIA TERESA', 'MARTINEZ', 'PUCHE', '1970-01-01', 'ESPAÑOLA', 'ESPAÑA', 'RIVAS VACIAMADRID', 28521, 'CALLE ROBLEDO, 2', 'M.TERESA.MARTINEZ@IEPGROUP.ES', FN_CREAR_NICK('M', 'JOYFE', 1), FN_CREAR_CONTRASENA(), '+34678901234', '+34910234567',1,0,NULL);
insert into MANAGER_COLEGIO(ID, NOMBRE, APELLIDO_1, APELLIDO_2, FECHA_NACIMIENTO, NACIONALIDAD, PAIS, CIUDAD, CP, DIRECCION, EMAIL, NICK, CONTRASENA, TELEFONO_1, TELEFONO_2, ID_COLEGIO, DELETED, F_BORRADO)
                            VALUES(2, 'PILAR', 'SANTOS', 'MENENDEZ', '1902-01-01', 'ESPAÑOLA', 'ESPAÑA', 'MADRID', 28027, 'CALLE MADRE ANTONIA PARÍS, 1', 'SOR.PRESA@DIOS.GOD', FN_CREAR_NICK('M', 'MATER IMMACULATA', 2), FN_CREAR_CONTRASENA(), '+34666666666', '+34915555555',2,0,NULL);
...
insert into DOCENTES(ID, NOMBRE, APELLIDO_1, APELLIDO_2, FECHA_NACIMIENTO, NACIONALIDAD, PAIS, CIUDAD, CP, DIRECCION, EMAIL, NICK, CONTRASENA, TELEFONO_1, TELEFONO_2, DELETED, F_BORRADO)
                            VALUES(1, 'JUAN JOSE', 'RODRIGUEZ', 'CALLEJA', '1982-01-01', 'ESPAÑOLA', 'ESPAÑA', 'SAN FERNANDO DE HENARES', 28824, 'PLAZA DEL ANGEL, 2', 'JON.RODRIGUEZ@IEPGROUP.ES', FN_CREAR_NICK('D', 'JOYFE', 1 ), FN_CREAR_CONTRASENA(), '+346543321098', '+34916723265',0,NULL);
insert into DOCENTES(ID, NOMBRE, APELLIDO_1, APELLIDO_2, FECHA_NACIMIENTO, NACIONALIDAD, PAIS, CIUDAD, CP, DIRECCION, EMAIL, NICK, CONTRASENA, TELEFONO_1, TELEFONO_2, DELETED, F_BORRADO)
                            VALUES(2, 'REMEDIOS', 'FUERTES', 'CRISTIANDAD', '1921-01-01', 'ESPAÑOLA', 'ESPAÑA', 'MADRID', 28011, 'CALLE VIRGEN DE LA HIGUERA, 2', 'REME.FUERTES@DIOS.GOD', FN_CREAR_NICK('D', 'MATER IMMACULATA', 2 ), FN_CREAR_CONTRASENA(), '+34642097531', '+34912032031',0,NULL);
...
insert into TUTORES(ID, NOMBRE, APELLIDO_1, APELLIDO_2, FECHA_NACIMIENTO, NACIONALIDAD, PAIS, CIUDAD, CP, DIRECCION, EMAIL, NICK, CONTRASENA, TELEFONO_1, TELEFONO_2, DELETED, F_BORRADO)
                            VALUES(1, 'FRANCISCO', 'GIMENEZ', 'PEREZ', '1982-01-01', 'ESPAÑOLA', 'ESPAÑA', 'MADRID', 28022, 'CALLE SUECIA, 2', 'FRAN.GIPE@PADRE.ES', FN_CREAR_NICK('T', 'JOYFE', 1 ), FN_CREAR_CONTRASENA(), '+34915357852', '+34919874563',0,NULL);
insert into TUTORES(ID, NOMBRE, APELLIDO_1, APELLIDO_2, FECHA_NACIMIENTO, NACIONALIDAD, PAIS, CIUDAD, CP, DIRECCION, EMAIL, NICK, CONTRASENA, TELEFONO_1, TELEFONO_2, DELETED, F_BORRADO)
                            VALUES(2, 'MERCEDES', 'MILANO', 'MILANO', '1974-01-01', 'ESPAÑOLA', 'ESPAÑA', 'MADRID', 28001, 'CALLE CENTRO, 2', 'MERCEDES.MILANO@MADRE.ES', FN_CREAR_NICK('T', 'MATER IMMACULATA', 2 ), FN_CREAR_CONTRASENA(), '+34678891248', '+34917526436',0,NULL);
...
insert into ESTUDIANTES(ID, NOMBRE, APELLIDO_1, APELLIDO_2, FECHA_NACIMIENTO, NACIONALIDAD, PAIS, CIUDAD, CP, DIRECCION, EMAIL, NICK, CONTRASENA, DATOS_MEDICOS, OBSERVACIONES, RUTA_FOTO, DELETED, F_BORRADO)
                            VALUES(1, 'CARMEN', 'GIMENEZ', 'GURRERO', '2010-01-01', 'ESPAÑOLA', 'ESPAÑA', 'MADRID', 28022, 'CALLE SUECIA, 2', 'CARMEN.MONTAÑA.GUERRERO@ALUMNOJOYFE.IEPGROUP.ES', FN_CREAR_NICK('E', 'JOYFE', 1 ), FN_CREAR_CONTRASENA(), 'SANA', 'MUY INTELIGENTE', 'C:\\IMAGES\FOTO.PNG',0,NULL);
insert into ESTUDIANTES(ID , NOMBRE, APELLIDO_1, APELLIDO_2, FECHA_NACIMIENTO, NACIONALIDAD, PAIS, CIUDAD, CP, DIRECCION, EMAIL, NICK, CONTRASENA, DATOS_MEDICOS, OBSERVACIONES, RUTA_FOTO, DELETED, F_BORRADO)
                            VALUES(2, 'CARLOS', 'MILANO', 'MELGAREJO', '2009-01-01', 'ESPAÑOLA', 'ESPAÑA', 'MADRID', 28001, 'CALLE CENTRO, 2', 'CARLOS.MILANO.MELGAREJO@ALUMNOJOYFE.IEPGROUP.ES', FN_CREAR_NICK('E', 'MATER IMMACULATA', 2), FN_CREAR_CONTRASENA(), 'SANO', 'TDAH', 'C:\\IMAGES\FOTICO.PNG',0,NULL);
